...
#define VOICEPACK_TYPE_MALE	"Male"
#define VOICEPACK_TYPE_FEMALE	"Female"
#define VOICEPACK_TYPE_DEF	"Default"

GLOBAL_LIST_INIT(voicepack_types_list, list(VOICEPACK_TYPE_MALE, VOICEPACK_TYPE_FEMALE, VOICEPACK_TYPE_DEF))
