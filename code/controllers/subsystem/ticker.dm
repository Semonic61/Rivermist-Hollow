...
SUBSYSTEM_DEF(ticker)
	...
	var/station_time_rate_multiplier = 200		//factor of station time progressal vs real time.
...
//		music -= old_login_music
	...
	login_music = pick('modular_rmh/sound/music/title.ogg') //New by Northern Flowers
