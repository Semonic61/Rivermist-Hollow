...
//	S["alignment"]			>> alignment
	...
	S["pronouns"]			>> pronouns
	S["voice_type"]			>> voice_type	//RMH edit
	S["voice_selection"]	>> voice_selection
	S["nickname"]			>> nickname
...
/datum/preferences/proc/load_character(slot)
	...
	S["voice_selection"]	>> voice_selection 	//RMH edit
	...
	voice_selection = sanitize_text(voice_selection, VOICEPACK_TYPE_DEF)	//RMH edit
...
//	WRITE_FILE(S["alignment"]			, alignment)
	...
	WRITE_FILE(S["voice_selection"] , voice_selection)	//RMH edit
