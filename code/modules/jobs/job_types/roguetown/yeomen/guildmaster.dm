...
/datum/job/roguetown/guildmaster
	...
	tutorial = "You are the leader of the Rivermist Hollow Guild of Crafts. You represents the interests of all of the craftsmen underneath you - including the Tailor\
