...
/datum/sex_action/toy_oral/can_perform(mob/living/user, mob/living/target)
	if(user != target)
		return FALSE
...
/datum/sex_action/toy_oral/on_start(mob/living/user, mob/living/target)
...
/datum/sex_action/toy_oral/on_perform(mob/living/user, mob/living/target)
	var/obj/item/dildo = get_dildo_in_either_hand(user)
